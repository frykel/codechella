...
const corpo = document.querySelector(".corpo__ingresso")
const imagem = document.querySelector(".ingresso__logo__imagem")
const ingresso = document.querySelector(".ingresso__container")
...
botao.addEventListener("click",(evento)=>{
    ...
    if(con==0){
        ...
        ingresso.classList.add("ingresso__container__boreal")
        imagem.src="../imagens/footer/desktop/logo-branca.png"
    ...
    con++
        ...
        ingresso.classList.remove("ingresso__container__boreal")

        rodape.classList.remove("rodape__boreal")
        imagem.src="../imagens/footer/desktop/logo-cinza.png"
